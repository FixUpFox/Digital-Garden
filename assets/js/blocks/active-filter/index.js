	...
	registerBlockType("digital-garden/active-filter", {
		...
		edit: function ActiveFilterEdit() {
			const blockProps = useBlockProps({
				className:
					"digital-garden-block-preview digital-garden-active-filter__preview",
			});
			...
			return el(
				...
				el(
					...
					el(
						...
						{
							className:
								"digital-garden-filter-select digital-garden-active-filter__select",
						...
						[
							el(
								...
								__("Recently published", "digital-garden"),
							),
							el(
								"option",
								{ value: "modified", key: "modified" },
								__("Recently updated", "digital-garden"),
							),
						],
					),
				),
